...
ADAFRUIT_IO_TEMP_FEEDNAME = credentials["ADAFRUIT_IO_TEMP_FEEDNAME"]
ADAFRUIT_IO_HUM_FEEDNAME = credentials["ADAFRUIT_IO_HUM_FEEDNAME"]
ADAFRUIT_IO_SPEED_FEEDNAME = credentials["ADAFRUIT_IO_SPEED_FEEDNAME"]
ADAFRUIT_IO_MAP_FEEDNAME = credentials["ADAFRUIT_IO_MAP_FEEDNAME"]
...
mqtt_temp_feedname = bytes('{:s}/feeds/{:s}'.format(ADAFRUIT_USERNAME, ADAFRUIT_IO_TEMP_FEEDNAME) , 'utf-8')
mqtt_hum_feedname = bytes('{:s}/feeds/{:s}'.format(ADAFRUIT_USERNAME, ADAFRUIT_IO_HUM_FEEDNAME) , 'utf-8')
mqtt_speed_feedname = bytes('{:s}/feeds/{:s}'.format(ADAFRUIT_USERNAME, ADAFRUIT_IO_SPEED_FEEDNAME) , 'utf-8')
mqtt_map_feedname = bytes('{:s}/feeds/{:s}'.format(ADAFRUIT_USERNAME, ADAFRUIT_IO_MAP_FEEDNAME) , 'utf-8')
